...
if(message.content.toLowerCase() === `${prefix}help`){
    ...
    .addField(` ** ❯ LINKS [2]**`,`   [Invite Me](https://discord.com/api/oauth2/authorize?client_id=850231402402414623&permissions=8&scope=bot)`+` - `+`[Support Server](https://discord.gg/764wQmTD)`)
    .setFooter("© μmoongazer07#1200")
    .setTimestamp()
